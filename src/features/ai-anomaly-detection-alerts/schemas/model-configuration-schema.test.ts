...
import { modelConfigurationFormSchema, modelConfigurationSchema } from "./model-configuration-schema";
...
describe("modelConfigurationFormSchema", () => {
  it("accepts a V2 model version with evaluation metrics", () => {
    expect(modelConfigurationSchema.safeParse({
      id: "00000000-0000-4000-8000-000000000001", modelName: "Detector",
      modelType: "isolation_forest", version: "2.0", status: "deployed",
      featureDefinition: null, parameters: null, dataset: null,
      latestEvaluation: null, deployedAt: null, retiredAt: null,
